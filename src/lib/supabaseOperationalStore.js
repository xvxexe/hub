...
function fromDocumentRow(row) {
  ...
  return {
    ...
    categoriaOriginale: row.categoria_originale,
    lavorazione: row.lavorazione ?? row.categoria_originale ?? row.sheet_tab,
    qualitaDati: row.qualita_dati,
    controlloMatematico: row.controllo_matematico,
    naturaMovimento: row.natura_movimento,
    statoCollegamento: row.stato_collegamento,
...
function toDocumentRow(document, session) {
  ...
  return {
    ...
    categoria_originale: document.categoriaOriginale ?? document.categoria_originale ?? document.lavorazione ?? document.categoria ?? null,
    lavorazione: document.lavorazione ?? document.categoriaOriginale ?? document.sheetTab ?? null,
    qualita_dati: document.qualitaDati ?? document.qualita_dati ?? 'Da controllare',
    controllo_matematico: document.controlloMatematico ?? document.controllo_matematico ?? 'Da controllare',
    natura_movimento: document.naturaMovimento ?? document.natura_movimento ?? null,
    stato_collegamento: document.statoCollegamento ?? document.stato_collegamento ?? 'Collegato',
    data_quality_note: document.dataQualityNote ?? document.data_quality_note ?? null,
...
function fromAccountingMovementRow(row) {
  ...
  return {
    ...
    categoriaOriginale: row.categoria_originale,
    lavorazione: row.lavorazione ?? row.categoria_originale ?? linkedDocument.sheet_tab ?? row.sheetTab ?? '',
    qualitaDati: row.qualita_dati,
    controlloMatematico: row.controllo_matematico,
    naturaMovimento: row.natura_movimento,
    statoCollegamento: row.stato_collegamento,
...
function toAccountingMovementRow(movement, session) {
  return {
    ...
    categoria_originale: movement.categoriaOriginale ?? movement.categoria_originale ?? movement.lavorazione ?? movement.categoria ?? null,
    lavorazione: movement.lavorazione ?? movement.categoriaOriginale ?? movement.sheetTab ?? null,
    qualita_dati: movement.qualitaDati ?? movement.qualita_dati ?? 'Da controllare',
    controllo_matematico: movement.controlloMatematico ?? movement.controllo_matematico ?? 'Da controllare',
    natura_movimento: movement.naturaMovimento ?? movement.natura_movimento ?? null,
    stato_collegamento: movement.statoCollegamento ?? movement.stato_collegamento ?? 'Collegato',
    data_quality_note: movement.dataQualityNote ?? movement.data_quality_note ?? null,

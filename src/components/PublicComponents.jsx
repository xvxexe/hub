...
function PublicIcon({ name }) {
  const paths = {
    cartongesso: (
      <>
        <path d="M4 9h16" /><path d="M4 15h16" /><path d="M8 5v14" /><path d="M16 5v14" />
      </>
    ),
    'ristrutturazioni-tecniche': (
      <>
        <path d="M4 20h16" /><path d="M7 20V8l5-4 5 4v12" /><path d="M10 20v-6h4v6" />
      </>
    ),
    'finiture-interne': (
      <>
        <path d="M5 19h14" /><path d="M7 19V9l5-5 5 5v10" /><path d="M9 13h6" />
      </>
    ),
    'gestione-cantiere': (
      <>
        <path d="M4 20h16" /><path d="M6 20V8h6v12" /><path d="M12 20V5h6v15" /><path d="M8 11h2M8 14h2M14 9h2M14 12h2" />
      </>
    ),
    manutenzioni: (
      <>
        <path d="M14.7 6.3a4 4 0 0 0-5.4 5.4L4 17l3 3 5.3-5.3a4 4 0 0 0 5.4-5.4" /><path d="m15 5 4 4" />
      </>
    ),
    'supporto-operativo': (
      <>
        <path d="M12 3 4 7v6c0 5 3.4 7.6 8 9 4.6-1.4 8-4 8-9V7l-8-4Z" /><path d="m9 12 2 2 4-5" />
      </>
    ),
  }

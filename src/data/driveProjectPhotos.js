...
export const driveServiceImages = {
  ...
  manutenzioni: srcByName(capriGallery, 'IMG_8849.JPG', 0),
...
export const drivePublicProjects = [
  {
    ...
    contextNote: 'Intervento in struttura ricettiva con aree interne attive, passaggi impiantistici e zone da proteggere durante le fasi di lavoro.',
    solution: 'Esecuzione progressiva di cartongessi, chiusure, riprese e finiture con controllo fotografico delle aree trattate.',
    workNote: 'Le lavorazioni hanno riguardato chiusure a secco, preparazione di passaggi tecnici, riprese interne e coordinamento operativo tra le diverse zone del cantiere.',
    serviceDetails: {
      Cartongesso: 'Montaggio e chiusura di pareti e porzioni tecniche in cartongesso, con attenzione ad allineamenti e continuità delle superfici.',
      'Finiture interne': 'Riprese, rasature e preparazioni finali nelle aree trattate prima della chiusura delle lavorazioni.',
      'Gestione cantiere': 'Coordinamento delle lavorazioni in più zone della struttura, mantenendo ordine, accessi e documentazione fotografica.',
      'Supporto operativo': 'Presidio operativo per assistenze, movimentazioni e interventi collegati alle fasi interne del cantiere.',
    },
    results: ['Aree operative documentate', 'Finiture tracciate', 'Avanzamento controllato'],
    resultDetails: {
      'Aree operative documentate': 'Le principali zone di lavoro sono state fotografate e ordinate per rendere leggibile lo stato del cantiere.',
      'Finiture tracciate': 'Le riprese e le chiusure interne risultano collegate alle relative immagini di avanzamento.',
      'Avanzamento controllato': 'La scheda mostra un percorso coerente tra preparazione, lavorazione e controllo delle aree trattate.',
    },
  ...
  },
  {
    ...
    contextNote: 'Cantiere in località ricettiva con ambienti interni da proteggere, passaggi tecnici visibili e spazi ridotti da mantenere ordinati.',
    ...
    workNote: 'Le attività hanno riguardato predisposizioni interne, gestione dei passaggi impiantistici, chiusure progressive e documentazione dello stato delle aree.',
    serviceDetails: {
      'Preparazione aree': 'Pulizia operativa, protezione degli spazi e preparazione delle superfici prima delle chiusure e delle finiture.',
      'Finiture interne': 'Riprese e completamenti visivi nelle aree interne, con attenzione alla continuità delle superfici.',
      'Gestione cantiere': 'Organizzazione delle fasi in ambienti ristretti e coordinamento delle lavorazioni con le esigenze della struttura.',
      'Documentazione fotografica': 'Foto di avanzamento selezionate per mostrare lavorazioni, passaggi tecnici e stato reale degli ambienti.',
    },
    results: ['Ambienti preparati', 'Passaggi tecnici ordinati', 'Località separata nel portfolio'],
    resultDetails: {
      'Ambienti preparati': 'Le aree interne risultano predisposte per le successive fasi di chiusura e finitura.',
      'Passaggi tecnici ordinati': 'Impianti, aperture e zone operative sono stati documentati in modo leggibile.',
      'Località separata nel portfolio': 'Il materiale di Capri resta distinto dagli altri cantieri per evitare confusione tra località.',
    },
  ...
  },
  {
    ...
    contextNote: 'Ambiente retail in cui le lavorazioni interne devono restare ordinate, precise e compatibili con uno standard estetico elevato.',
    ...
    workNote: 'Il lavoro ha compreso predisposizioni tecniche, chiusure interne, finiture e assistenze operative tipiche di uno spazio commerciale.',
    serviceDetails: {
      'Retail fit-out': 'Interventi interni coordinati per adeguare lo spazio commerciale alle esigenze del punto vendita.',
      'Finiture interne': 'Cura di superfici, chiusure e dettagli visivi coerenti con un ambiente retail.',
      'Supporto operativo': 'Assistenze di cantiere e attività collegate alle fasi di allestimento interno.',
      'Documentazione fotografica': 'Raccolta di immagini per distinguere il lavoro di Napoli dagli altri cantieri del portfolio.',
    },
    results: ['Spazio commerciale documentato', 'Fasi interne ordinate', 'Scheda retail riconoscibile'],
    resultDetails: {
      'Spazio commerciale documentato': 'Le immagini raccontano l’intervento come lavoro retail, non come generico cantiere interno.',
      'Fasi interne ordinate': 'Preparazioni, assistenze e finiture sono presentate con un ordine coerente.',
      'Scheda retail riconoscibile': 'La località Napoli e il contesto commerciale sono separati dal resto del portfolio.',
    },
  ...
  },
  {
    ...
    contextNote: 'Cantiere internazionale con necessità di organizzare squadra, materiali e lavorazioni in una località estera.',
    ...
    workNote: 'L’intervento è stato impostato come supporto operativo all’estero, con preparazioni interne, assistenze e finiture documentate per fasi.',
    serviceDetails: {
      'Finiture interne': 'Completamenti e riprese interne eseguite in trasferta, con attenzione a superfici e dettagli visivi.',
      'Supporto operativo': 'Presenza di squadra per gestire attività operative fuori sede e mantenere continuità nel lavoro.',
      'Gestione cantiere': 'Coordinamento di fasi, accessi e materiali in contesto internazionale.',
      'Documentazione fotografica': 'Galleria dedicata per separare Parigi dai cantieri italiani e dagli altri lavori esteri.',
    },
    results: ['Trasferta documentata', 'Fasi interne leggibili', 'Portfolio internazionale ampliato'],
    resultDetails: {
      'Trasferta documentata': 'Il lavoro all’estero viene mostrato con immagini dedicate alla località Parigi.',
      'Fasi interne leggibili': 'Le foto rendono chiaro l’avanzamento delle lavorazioni interne.',
      'Portfolio internazionale ampliato': 'La scheda evidenzia la capacità di operare anche fuori Italia.',
    },
  ...
  },
  {
    ...
    contextNote: 'Cantiere estero con lavorazioni a secco e fasi interne da organizzare in trasferta, mantenendo standard e ordine operativo.',
    solution: 'Montaggi a secco, preparazioni, chiusure e riprese interne eseguite con controllo ordinato delle fasi operative.',
    workNote: 'Le attività hanno riguardato montaggi, chiusure interne, predisposizioni e assistenze operative in località estera.',
    serviceDetails: {
      Cartongesso: 'Montaggi a secco, pareti e chiusure interne realizzate nel contesto del cantiere estero.',
      'Ristrutturazioni tecniche': 'Preparazioni e adattamenti interni collegati alle esigenze operative della trasferta.',
      'Finiture interne': 'Riprese e completamenti sulle superfici trattate, con attenzione al risultato finale.',
      'Supporto operativo': 'Squadra e attrezzature coordinate per lavorare fuori Italia con continuità.',
    },
    results: ['Cantiere estero documentato', 'Lavorazioni a secco tracciate', 'Materiale separato per Berlino'],
    resultDetails: {
      'Cantiere estero documentato': 'Le immagini raccontano l’intervento di Berlino come scheda autonoma del portfolio.',
      'Lavorazioni a secco tracciate': 'Montaggi, chiusure e preparazioni sono presentati come fasi del cantiere.',
      'Materiale separato per Berlino': 'Le foto restano distinte dagli altri lavori esteri e italiani.',
    },

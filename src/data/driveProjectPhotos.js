...
export const drivePublicProjects = [
  {
    ...
    summary: 'Cantiere hospitality collegato alla cartella Drive categorizzata Barcelo Roma.',
    longText: 'Scheda pubblica generata dalla cartella Drive Barcelo Roma. Le immagini attuali del portfolio sono state sostituite con foto selezionate e ordinate per località/cantiere.',
    ...
    challenge: 'Gestire più aree di lavoro mantenendo ordine, pulizia e continuità operativa.',
    solution: 'Utilizzo di foto categorizzate per cantiere e scheda pubblica unica collegata alla località corretta.',
    results: ['Foto ordinate', 'Cantiere riconoscibile', 'Portfolio aggiornato'],
    gallery: barceloRomaGallery,
    note: 'Fonte foto: cartella Drive categorizzata Barcelo Roma.',
  },
  {
    id: 'capri',
    title: 'Capri',
    ...
    summary: 'Cantiere/località creato dalla cartella Drive Capri.',
    longText: 'Capri è stato aggiunto come cantiere pubblico perché presente come cartella categorizzata nel Drive foto. La scheda usa solo immagini provenienti da quella cartella.',
    ...
    challenge: 'Separare correttamente le foto Capri dagli altri cantieri già presenti.',
    solution: 'Creazione di una scheda dedicata con galleria filtrata dalla cartella Capri.',
    results: ['Nuovo cantiere creato', 'Foto separate', 'Portfolio più ordinato'],
    gallery: capriGallery,
    note: 'Fonte foto: cartella Drive categorizzata Capri.',
  },
  {
    ...
    summary: 'Scheda pubblica creata dalla cartella Drive Saint laurent Napoli.',
    longText: 'Saint Laurent Napoli è stato aggiunto come cantiere pubblico perché presente tra le cartelle foto categorizzate. Le immagini sono collegate esclusivamente alla cartella dedicata.',
    ...
    challenge: 'Rendere riconoscibile il lavoro retail senza mischiare immagini di altre località.',
    solution: 'Scheda separata per località e galleria basata sulla cartella Drive dedicata.',
    results: ['Cantiere creato', 'Foto categorizzate', 'Navigazione più chiara'],
    gallery: saintLaurentNapoliGallery,
    note: 'Fonte foto: cartella Drive categorizzata Saint laurent Napoli.',
  },
  {
    id: 'parigi',
    title: 'Parigi',
    ...
    summary: 'Scheda pubblica creata dalla cartella Drive Parigi.',
    longText: 'Parigi è stato aggiunto come cantiere/località pubblico perché presente tra le cartelle foto categorizzate. La galleria usa solo le immagini selezionate in quella cartella.',
    ...
    challenge: 'Separare il materiale fotografico internazionale dalle altre lavorazioni.',
    solution: 'Creazione di una scheda dedicata con immagini provenienti dalla cartella Parigi.',
    results: ['Nuovo cantiere creato', 'Foto ordinate', 'Portfolio ampliato'],
    gallery: parigiGallery,
    note: 'Fonte foto: cartella Drive categorizzata Parigi.',
  },
  {
    id: 'berlino',
    title: 'Berlino',
    ...
    summary: 'Scheda pubblica creata dalla cartella Drive Berlino.',
    longText: 'Berlino è stato aggiunto come cantiere/località pubblico perché presente tra le cartelle foto categorizzate. La scheda sostituisce le immagini precedenti con quelle selezionate nella nuova struttura Drive.',
    ...
    challenge: 'Aggiornare il portfolio con materiale fotografico già ordinato per località.',
    solution: 'Nuova scheda pubblica basata sulla cartella Drive Berlino e immagini non mischiate con altri cantieri.',
    results: ['Nuovo cantiere creato', 'Foto categorizzate', 'Portfolio più completo'],
    gallery: berlinoGallery,
    note: 'Fonte foto: cartella Drive categorizzata Berlino.',
  },
]
